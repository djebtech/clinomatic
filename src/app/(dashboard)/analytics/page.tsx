  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 text-sm">التحليلات — statistiques détaillées</p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StatsCard title="Taux de confirmation" value={`${thisWeek.confirmationRate.toFixed(1)}%`} icon="check" />
        <StatsCard title="Taux de présence" value={`${thisWeek.attendanceRate.toFixed(1)}%`} icon="user-check" />
      </div>
